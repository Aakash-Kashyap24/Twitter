    ...
    const toggleLike = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(async ()=>{
        ...
        try {
            ...
            if (hasLiked) {
                ...
                request = ()=>axios__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"](`/api/like?postId=${postId}&userId?=${userId}`);
            } else {
...
const usePosts = (userid)=>{
    ...
    const { data, error, isLoading, mutate } = (0,swr__WEBPACK_IMPORTED_MODULE_1__["default"])(url, _libs_fetcher__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z);
    return {
        data,
        error,
        isLoading,
